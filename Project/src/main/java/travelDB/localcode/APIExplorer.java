...
public class APIExplorer {
	...
	public String getLocalcodeInfo() {
		
		StringBuilder sb = new StringBuilder();
		
    	// 1. URL을 만들기 위한 StringBuilder.        
		StringBuilder urlBuilder = new StringBuilder("https://apis.data.go.kr/B551011/KorWithService1/areaCode1?serviceKey=tiJTPvfW4NC4ed9%2BwQDxN8bmWLHARc0NZ7m2gGgVC9I656sZDIgp%2B4kuwkwIBFE0k%2Fkd2gAaj%2F%2BhCIwPRLE6uQ%3D%3D&numOfRows=20&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json");
